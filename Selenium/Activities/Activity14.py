...
with webdriver.Firefox(service=service) as driver:
    ...
    print("Cell value at second row and second column before sorting: ", second_row_second_cell_before_sort.text)
    ...
    # Print the cell value
    print("Cell value at second row and second column after sorting: ", second_row_second_cell_after_sort.text)