...
with webdriver.Firefox(service=service) as driver:
    ...
    for i in range(1,10):
        leadName = driver.find_element(By.XPATH, f"//table/tbody/tr[{i}]/td[3]/b")
        print(leadName.text)

        leadUserRole = driver.find_element(By.XPATH, f"//table/tbody/tr[{i}]/td[8]")
        print(leadUserRole.text)
